...
export default function RecipeCard({ className, ...props }: RecipeCardProps): JSX.Element {
    return (
        <div className={cn('relative rounded-xl border border-gray-50 p-5 shadow-md', className)} {...props}>
            <Tag className="absolute left-0 top-[-12px]" color="red">
                Most Popular
            </Tag>
            <div className="mb-5 flex h-64 items-center overflow-hidden rounded-xl">
                <Image
                    alt="gg"
                    height={0}
                    sizes="100vw"
            ...
            <div className="mb-10 flex flex-wrap items-start gap-1">
            ...
            <p className="mb-4 line-clamp-2 text-sm font-light text-gray-500">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi quasi quaerat iure odio adipisci debitis assumenda quisquam corporis, ipsum consectetur.
            </p>
            <span className="block text-xs font-light text-gray-500">
                Difficulty:&nbsp;<span className="font-normal text-yellow-500">Medium</span>
            </span>

            <span className="mb-4 block text-xs font-light text-gray-500">Cuisine:&nbsp;Pakistani</span>
